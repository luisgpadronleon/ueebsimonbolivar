...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE padmin SET nombre=%s, cedula=%s, cargo=%s WHERE id=%s",
...
$varID_padmin = "0";
if (isset($_GET['id'])) {
  $varID_padmin = $_GET['id'];
}
mysql_select_db($database_puertoLab, $puertoLab);
$query_padmin = sprintf("SELECT * FROM padmin WHERE padmin.id = %s", GetSQLValueString($varID_padmin, "int"));
...
<li><a href="#" class="active">MODIFICAR DATOS DE PERSONAL ADMINISTRATIVO</a> </li>
</ul>
...
<h4>Modificando datos de: <span class="semi-bold"> <?php echo $row_padmin['nombreA']; ?></span></h4>
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="formulario">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="nombre" value="<?php echo htmlentities($row_padmin['nombre'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Cedula:</td>
        <td><input type="text" name="cedula" value="<?php echo htmlentities($row_padmin['cedula'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Cargo:</td>
        <td><input type="text" name="cargo" value="<?php echo htmlentities($row_padmin['cargo'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
    ...
    <input type="hidden" name="id" value="<?php echo $row_padmin['id']; ?>">
  </form>
  <p>&nbsp;</p>
<p>&nbsp;</p>
</div>
