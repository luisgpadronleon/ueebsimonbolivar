...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pdocente SET nombre=%s, cedula=%s, direccion=%s, telefono=%s, grado=%s WHERE id=%s",
...
$varID_pdocente = "0";
if (isset($_GET['id'])) {
  $varID_pdocente = $_GET['id'];
}
mysql_select_db($database_puertoLab, $puertoLab);
$query_pdocente = sprintf("SELECT * FROM pdocente WHERE pdocente.id = %s", GetSQLValueString($varID_pdocente, "int"));
...
<li><a href="#" class="active">MODIFICAR DATOS DEL DOCENTE</a> </li>
</ul>
...
<h4>Modificando datos de: <span class="semi-bold"> <?php echo $row_pdocente['nombre']; ?></span></h4>
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="formulario">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="nombre" value="<?php echo htmlentities($row_pdocente['nombre'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Cédula</td>
        <td><input type="text" name="cedula" value="<?php echo htmlentities($row_pdocente['cedula'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Dirección</td>
        <td><input type="text" name="direccion" value="<?php echo htmlentities($row_pdocente['direccion'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Teléfono:</td>
        <td><input type="text" name="telefono" value="<?php echo htmlentities($row_pdocente['telefono'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Grado</td>
        <td><input type="text" name="grado" value="<?php echo htmlentities($row_pdocente['grado'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
    ...
    <input type="hidden" name="id" value="<?php echo $row_pdocente['id']; ?>">
  </form>
  <p>&nbsp;</p>
</div>
</div>
